    ...
    <body>
        ...
        <main class="main-content">
            ...
            <section class="contact-info-row">
                <div class="info-card">
                    ...
                    <div class="info-text">coresharetech@gmail.com</div>
                </div>
                <div class="info-card">
        ...
        <script>
            document.getElementById('contact-form').addEventListener('submit', function(e) {
                ...
                fetch('../php/submit_contact.php', { method: 'POST', body: formData })
                .then(response => response.json())
                .then(data => {
                    if(data.success) { showToast('Message sent successfully!', 'success'); this.reset(); }
